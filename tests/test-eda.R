...
test_that('riding_shps_with_totals_for_year_party returns a SpatialPolygonsDataFrame with coorect totals', {
  result <- lft_plots$riding_shps_with_totals_for_year_party(2013, 'Conservative')
